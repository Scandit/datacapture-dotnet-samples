    ...
    public static class CapturedIdExtentions
    {
        public static IList<ResultEntry> GetCommonRows(this CapturedId capturedId)
        {
            ...
            return new[] {
                ...
                new ResultEntry(value: capturedId.CapturedResultType.ToString(), title: "Captured Result Type"),
                new ResultEntry(value: capturedId.DocumentType.ToString(), title: "Document Type"),
