...
namespace MatrixScanCountSimpleSample
{
    public sealed class BarcodeManager
    {
        ...
        private List<Barcode> scannedBarcodes = null!;
        private List<Barcode> additionalBarcodes = null!;
        ...
        public IDictionary<string, ScanItem> GetScanResults()
        {
            ...
            void copyToResult(Barcode barcode)
            {
                ...
                if (barcode.Data != null && scanResults.ContainsKey(barcode.Data))
                {
                    scanResults[barcode.Data].IncreaseQuantity();
                }
                else if (barcode.Data != null)
                {
                    scanResults.Add(
                        barcode.Data,
                        new ScanItem(
