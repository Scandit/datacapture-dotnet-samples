...
namespace MatrixScanBubblesSample.Scan
{
    public class ScanFragment : CameraPermissionFragment, IScanViewModelListener
    {
        ...
        private BarcodeBatchAdvancedOverlay bubblesOverlay;
        private BarcodeBatchBasicOverlay highlightOverlay;
                ...
                Bundle savedInstanceState)
        {
            ...
            this.highlightOverlay = BarcodeBatchBasicOverlay.Create(
                this.viewModel.BarcodeBatch, dataCaptureView, BarcodeBatchBasicOverlayStyle.Dot);

            // We create an overlay for the bubbles.
            this.bubblesOverlay = BarcodeBatchAdvancedOverlay.Create(
            ...
            bool visible)
        {
            ...
            if (bubble == null)
            {
                // There's no recyclable bubble for this batch identifier, so we create one.
