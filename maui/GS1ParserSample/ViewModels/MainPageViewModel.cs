...
namespace GS1ParserSample.ViewModels
{
    public class MainPageViewModel : BaseViewModel, IBarcodeCaptureListener
    {
        ...
        private void InitializeScanner()
        {
            ...
            this.HighlightingBrush = new Brush(fillColor: Colors.Transparent.ToPlatform(),
                                               strokeColor: Colors.White.ToPlatform(),
                                               strokeWidth: 3);
        }
        ...
        public void OnBarcodeScanned(BarcodeCapture barcodeCapture, BarcodeCaptureSession session, IFrameData frameData)
        {
            ...
            try
            {
                ...
                MessageService.ShowAsync(sb.ToString(), "Parser result")
                              .ContinueWith((task) => barcodeCapture.Enabled = true);
            }
