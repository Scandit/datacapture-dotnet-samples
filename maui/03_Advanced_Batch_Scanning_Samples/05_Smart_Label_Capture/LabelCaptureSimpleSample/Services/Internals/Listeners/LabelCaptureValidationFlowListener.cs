...
internal class LabelCaptureValidationFlowListener(Action<string> onLabelScanned) : ILabelCaptureValidationFlowListener
{
    public void OnValidationFlowLabelCaptured(IList<LabelField> fields)
    {
        ...
        {
            // Ensure we're on the main thread when calling the callback
