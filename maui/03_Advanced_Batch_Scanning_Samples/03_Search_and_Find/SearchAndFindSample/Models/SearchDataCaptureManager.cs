...
public class SearchDataCaptureManager
{
    ...
    public BarcodeCaptureSettings Settings { get; init; }

    private SearchDataCaptureManager()
    {
        // The barcode capturing process is configured through barcode capture settings
        // which are then applied to the barcode capture instance that manages barcode recognition.
        this.Settings = BarcodeCaptureSettings.Create();
        ...
        this.Settings.EnableSymbologies(enabledSymbologies);
        ...
        this.Settings.LocationSelection = RadiusLocationSelection.Create(new FloatWithUnit(0f, MeasureUnit.Fraction));
        ...
        this.Settings.CodeDuplicateFilter = TimeSpan.FromSeconds(1.0d);

        // Create new barcode capture mode with the settings from above.
        this.BarcodeCapture = BarcodeCapture.Create(this.Settings);
    }
}
