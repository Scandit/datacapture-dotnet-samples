...
using Scandit.DataCapture.Text.UI.Overlay;

namespace TextCaptureSample.Views
{
    public partial class MainPage : ContentPage
    {
        private TextCaptureOverlay overlay;
        ...
        {
            this.overlay = TextCaptureOverlay.Create(this.viewModel.TextCapture);
