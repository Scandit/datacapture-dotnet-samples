...
namespace ListBuildingSample.Views
{
    public class ItemsTableHeaderView : UIView
    {
        ...
        public const int LabelLeadingMargin = 15;
        public const int LabelTopMargin = 10;
        public const string DefaultLabel = "0 items";

        public UILabel ItemsCountLabel { get; private set; } = null!;
