...
namespace ListBuildingSample.Views
{
    public class ItemTableViewCell : UITableViewCell
    {
        ...
        public const int BarcodeImageLeadingMargin = 15;
        public const int BarcodeImageTopMargin = 10;
        public const int BarcodeImageSize = 50;
        public const int TitleLeadingMargin = 75;
        public const int TitleTopMargin = 15;
        public const int TitleHeight = 20;
        public const int SubtitleLeadingMargin = 75;
        public const int SubtitleTopMargin = 35;
        public const int SubtitleHeight = 20;

        private ListItem item = null!;

        public UIImageView? BarcodeImage { get; private set; }
        public UILabel Title { get; private set; } = null!;
        ...
        public void Configure(ListItem item)
        {
            ...
            {
                throw new InvalidOperationException("Cannot configure view cell");
            }
