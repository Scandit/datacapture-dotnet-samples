...
namespace MatrixScanCountSimpleSample
{
    public class ListCell : UITableViewCell
    {
        ...
        private UIImageView itemImageView = new UIImageView();
        private UILabel nameLabel = new UILabel();
        private UILabel dataLabel = new UILabel();
        private UILabel quantityLabel = new UILabel();
