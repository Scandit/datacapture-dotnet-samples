...
internal class LabelCaptureService : ILabelCaptureService
{
    ...
    {
        var labelCaptureSettings = BuildLabelCaptureSettings();
        ...
        Action<string> onLabelScanned)
    {
        ...
        var overlay = LabelCaptureValidationFlowOverlay.Create(this.labelCapture, view);
