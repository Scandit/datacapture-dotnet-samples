...
{
    public partial class ScanViewController : UIViewController, IBarcodeBatchListener, IBarcodeBatchAdvancedOverlayListener
    {
        ...
        private void SetupRecognition()
        {
            ...
            this.barcodeBatch = BarcodeBatch.Create(this.context, settings);
            ...
            // to the view.
            this.basicOverlay = BarcodeBatchBasicOverlay.Create(this.barcodeBatch, this.captureView, BarcodeBatchBasicOverlayStyle.Dot);
            ...
            this.advancedOverlay = BarcodeBatchAdvancedOverlay.Create(this.barcodeBatch, this.captureView);
        ...
        public UIView ViewForTrackedBarcode(BarcodeBatchAdvancedOverlay overlay, TrackedBarcode trackedBarcode)
        {
