...
public class ProductManager
{
    ...
    /// </summary>
    public IList<DisplayProduct> GetPickResultContent()
    {
        IList<DisplayProduct> pickList = BuildPickedProductsListAndSetPickedProductsCount();
        IList<DisplayProduct> inventoryList = GetInventoryList();
    ...
    /// </summary>
    public IList<DisplayProduct> BuildPickedProductsListAndSetPickedProductsCount()
    {
        List<DisplayProduct> displayItems = new();
        ...
        lock (_allPickedCodes)
        {
            foreach (string itemData in _allPickedCodes)
            {
                ...
                else
                {
                    ...
                    displayItems.Add(new DisplayProduct(
                        identifier: DisplayProduct.UnknownProduct,
                        quantityToPick: 0,
    ...
    /// <summary>
    /// Verifies the product in the database.
    /// </summary>
    /// <param name="itemData">The item data to verify.</param>
    /// <returns>True if the product is found in the database; otherwise, false.</returns>
    public bool VerifyProduct(string itemData)
    {
